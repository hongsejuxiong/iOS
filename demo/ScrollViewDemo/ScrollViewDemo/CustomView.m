...
//    [@"图片：" drawInRect:CGRectMake(10, 340, 80, 20) withAttributes:font];
    ...
    CGContextAddLineToPoint(context, 120+ (fw- 120)/2, 200);
...
//        CGContextDrawTiledImage(context, CGRectMake(0, 0, 20, 20), image.CGImage);//平铺图
    ...
    CGContextMoveToPoint(context, 120, 400);//设置Path的起点
